...
INSERT INTO faq_items (question, answer, category, status) VALUES
  ...
  ('Is SynthStack free to use?', 'Yes! The Community Edition is open-source under the MIT License and free to use, including commercially. Pro is optional for additional premium features and support.', 'Pricing', 'published'),
