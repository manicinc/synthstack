...
| Tier       | Max Flows | Daily Executions | Max Nodes/Flow |
|------------|-----------|------------------|----------------|
| Free       | 0         | 0                | 0              |
| Pro        | 10        | 500              | 50             |
| Agency     | 50        | 5,000            | 100            |
| Lifetime   | 25        | 2,500            | 75             |
| Enterprise | 999,999   | 999,999          | 500            |
...
export const TIER_WORKFLOW_MULTIPLIERS: Record<SubscriptionTier, number> = {
  ...
  enterprise: 0.5,
  lifetime: 0.8,
  unlimited: 0.75, // Legacy alias: treat as Agency-like (not truly unlimited)
};
```
...
export const FREE_EXECUTIONS_PER_TIER: Record<SubscriptionTier, number> = {
  ...
  enterprise: 500,
  lifetime: 30,
  unlimited: 100, // Legacy alias: treat as Agency-like (not truly unlimited)
};
```
